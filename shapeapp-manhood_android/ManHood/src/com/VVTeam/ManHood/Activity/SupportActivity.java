...
public class SupportActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) customTitleView.findViewById(R.id.actionbar_title_text_view)).setText(R.string.give_feedback_caps);
        ...
        if (savedInstanceState == null) {
            openSupportFragment(false);
        }
        
        GoogleTracker.StarSendView(this, SupportActivity.class.getSimpleName());
    }

    public void openSupportFragment(boolean isAddToBackStack) {
        SupportFragment soughtForFragment = (SupportFragment) getFragmentManager()
        ...
        Fragment newFragment = SupportFragment.newInstance();
